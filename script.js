    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "עמית | דפי נחיתה שמייצרים לקוחות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '01bb2afe-ad07-4070-ac04-89a7cd2a6841',
                    name: data.name || '',
                    email: data.email || '',
